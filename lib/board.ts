...
const ZONE_MOVES: Partial<Record<Zone, Move[]>> = {
  ...
  // 陰部チェックを終えて洗い場に来た馬はそのまま帰ることがあるので帰宅も選べる
  "洗い場": [
    { label: "待機", to: "待機" },
    { label: "待機馬房", to: "待機馬房" },
    { label: "帰宅", to: "帰宅" },
...
// 本日の予定（テスト　順番表.xlsx シート「4-13」から取り込み。8:00の組）
export const roster8Sample: RosterEntry[] = [
  { id: "r-kbl", mareName: "エジプシャンストーム", sireCode: "ＫＢＬ", farm: "ヤナガワ牧場", kind: "新", apptTime: "7:30", arrived: false },
  { id: "r-eqx", mareName: "ネバーギブアップ", sireCode: "ＥＱＸ", farm: "服部牧場", kind: "再", apptTime: "7:30", arrived: false },
  { id: "r-kzn", mareName: "ラブインジエア", sireCode: "ＫＺＮ", farm: "千代田牧場", kind: "新", apptTime: "", arrived: false },
  { id: "r-con", mareName: "テイハ", sireCode: "ＣＯＮ", farm: "ＮＦ", kind: "再", apptTime: "", arrived: false },
  { id: "r-epn", mareName: "グランドマルク", sireCode: "ＥＰＮ", farm: "ＳＦ", kind: "再", apptTime: "", arrived: false },
  { id: "r-ldk", mareName: "アートハウス", sireCode: "ＬＤＫ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false, note: "昼KZN" },
  { id: "r-stn", mareName: "ヴィアフィレンツェ", sireCode: "ＳＴＮ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r-dfo", mareName: "ドロミティ", sireCode: "ＤＦＯ", farm: "村上欽哉牧場", kind: "新", apptTime: "8:30", arrived: false },
  ...
  { id: "r-efo", mareName: "ベルフィオーレ", sireCode: "ＥＦＯ", farm: "ケイアイＦ", kind: "新", apptTime: "", arrived: false, note: "昼AMS" },
  { id: "r-lvl", mareName: "シゲルチャグチャグ", sireCode: "ＬＶＬ", farm: "コスモヴューＦ", kind: "再", apptTime: "", arrived: false },
  { id: "r-sis", mareName: "スカイラー", sireCode: "ＳＩＳ", farm: "高橋Ｆ", kind: "新", apptTime: "", arrived: false, note: "昼SIS" },
  { id: "r-orf", mareName: "モンゴリアンチャンガ", sireCode: "ＯＲＦ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r-shy", mareName: "ウィラビーオーサム", sireCode: "ＳＨＹ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false },
  ...
  { id: "r-gdg", mareName: "セレッソブランコ", sireCode: "ＧＤＧ", farm: "天羽禮治牧場", kind: "新", apptTime: "8:30", arrived: false },
  { id: "r-hrc", mareName: "エスキモーキセス", sireCode: "ＨＲＣ", farm: "ＳＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r-poe", mareName: "ハルワタート", sireCode: "ＰＯＥ", farm: "ＳＦ", kind: "新", apptTime: "", arrived: false },
];

// 昼（13:00）の組（同シートより）
export const roster13Sample: RosterEntry[] = [
  { id: "r13-kbl", mareName: "ワグニス", sireCode: "ＫＢＬ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r13-eqx", mareName: "コミッショニング", sireCode: "ＥＱＸ", farm: "ＮＦ", kind: "再", apptTime: "", arrived: false },
  { id: "r13-kzn", mareName: "フルーリア", sireCode: "ＫＺＮ", farm: "ノースヒルズ", kind: "新", apptTime: "", arrived: false },
  { id: "r13-ddc", mareName: "プリモシーン", sireCode: "ＤＤＣ", farm: "ＮＦ", kind: "再", apptTime: "", arrived: false },
  ...
  { id: "r13-mau", mareName: "シングルハーテッド", sireCode: "ＭＡＵ", farm: "ＮＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r13-ams", mareName: "インディゴブルー", sireCode: "ＡＭＳ", farm: "奥山Ｆ", kind: "新", apptTime: "13:30", arrived: false, note: "朝MAU" },
  { id: "r13-efo", mareName: "オパールムーン", sireCode: "ＥＦＯ", farm: "Ｂｌｏｏｍｉｎｇ Ｆ", kind: "新", apptTime: "", arrived: false, note: "昼AMS" },
  { id: "r13-lvl", mareName: "クリストフォリ", sireCode: "ＬＶＬ", farm: "奥山Ｆ", kind: "新", apptTime: "", arrived: false },
  { id: "r13-sis", mareName: "ポールネイロン", sireCode: "ＳＩＳ", farm: "ノースヒルズ", kind: "新", apptTime: "13:30", arrived: false, note: "昼SIS" },
  { id: "r13-bop", mareName: "ベネフィット", sireCode: "ＢＯＰ", farm: "ナカノＦ", kind: "新", apptTime: "13:30", arrived: false, note: "上り" },
  { id: "r13-rey", mareName: "ガートルード", sireCode: "ＲＥＹ", farm: "三村卓也", kind: "新", apptTime: "", arrived: false, note: "OV" },
...
export const roster17Sample: RosterEntry[] = [
  ...
  { id: "r17-ldk", mareName: "コンクシェル", sireCode: "ＬＤＫ", farm: "ノースヒルズ（土居牧場）", kind: "新", apptTime: "16:30", arrived: false, note: "昼KZN" },
  { id: "r17-ddc", mareName: "ティケイプルメリア", sireCode: "ＤＤＣ", farm: "モリナガＦ", kind: "新", apptTime: "", arrived: false },
  { id: "r17-dfo", mareName: "ファナティック", sireCode: "ＤＦＯ", farm: "天羽禮治牧場", kind: "新", apptTime: "", arrived: false },
  { id: "r17-ams", mareName: "トーホウラビアン", sireCode: "ＡＭＳ", farm: "吉田Ｆ", kind: "新", apptTime: "", arrived: false, note: "朝MAU" },
  { id: "r17-efo", mareName: "ナオミエキスプレス", sireCode: "ＥＦＯ", farm: "ヒダカＦ", kind: "再", apptTime: "", arrived: false, note: "昼AMS" },
